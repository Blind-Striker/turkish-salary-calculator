...
/// <inheritdoc />
internal sealed class TotalToGrossBuilder : ITotalToGrossBuilder
{
    ...
    internal TotalToGrossBuilder(ISalaryCalculator calculator)
    {
    ...
    {
        return Calculate(MonthlyInput.Uniform(totalCostBudget));
    }
