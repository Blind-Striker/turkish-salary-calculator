using Turkish.HRSolutions.SalaryCalculator.Api.Builders;
using Turkish.HRSolutions.SalaryCalculator.Api.Builders.Internal;

namespace Turkish.HRSolutions.SalaryCalculator.Api.Extensions;
