...
/// <summary>
/// Request for Gross-to-Net salary calculation.
/// </summary>
/// <remarks>
/// <para>
/// <b>Calculation Mode:</b> Given gross salaries, calculates net salaries and all deductions.
/// This is the most common calculation mode.
/// </para>
/// <para>
/// <b>Usage:</b> Create a request using the builder pattern:
/// <code>
/// var request = GrossToNetRequest.For(year: 2024)
...
/// <param name="Months">Monthly input data - 12 months of gross salaries (required).</param>
...
public sealed record GrossToNetRequest(
    int Year,
    ...
    RnDSettings? RnD = null)
{
    ...
    /// <summary>
    /// Starts building a Gross-to-Net request for the specified year.
    /// </summary>
    /// <param name="year">The calculation year.</param>
    /// <returns>A builder to configure the request.</returns>
    public static GrossToNetRequestBuilder For(int year) => new(year);
}

/// <summary>
/// Fluent builder for <see cref="GrossToNetRequest"/>.
/// </summary>
public sealed class GrossToNetRequestBuilder
{
    ...
    internal GrossToNetRequestBuilder(int year) => _year = year;

    /// <summary>
    /// Sets the monthly input data.
    /// </summary>
    public GrossToNetRequestBuilder WithMonths(IReadOnlyList<MonthlyInput> months)
    {
        _months = months;
        return this;
    }
    ...
    /// </summary>
    public GrossToNetRequestBuilder WithEmployeeType(EmployeeTypeId employeeType)
    {
    ...
    /// </summary>
    public GrossToNetRequestBuilder WithDisability(DisabilityDegreeId disability)
    {
    ...
    /// </summary>
    public GrossToNetRequestBuilder AsPensioner(bool isPensioner = true)
    {
    ...
    /// </summary>
    public GrossToNetRequestBuilder WithMinWageExemption(bool apply = true)
    {
    ...
    /// </summary>
    public GrossToNetRequestBuilder With5746Discount(bool apply = true)
    {
    ...
    /// </summary>
    public GrossToNetRequestBuilder WithAgi(AgiSettings agi)
    {
        _agi = agi;
        return this;
    }
    ...
    /// </summary>
    public GrossToNetRequestBuilder WithRnD(RnDSettings rnd)
    {
        _rnd = rnd;
        return this;
    }
    ...
    public GrossToNetRequest Build()
    {
